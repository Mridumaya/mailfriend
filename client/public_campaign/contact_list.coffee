...
Template.public_contact_list.rendered = ->
  ...
  $('div.dataTables_filter input').attr('placeholder', "Search by name or email address").after('<button type="submit"><img src="/images/search_button.png" alt="Search"></button>')
